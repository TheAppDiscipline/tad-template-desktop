...
export function AppShellView({ backendProvider, authMode, profile = 'LITE' }) {
    return h('main', { className: 'app-shell' }, [
        h('section', { key: 'hero', className: 'panel hero' }, [
            h('p', { key: 'eyebrow', className: 'eyebrow' }, 'Discipline Loop Desktop Template'),
            h('h1', { key: 'title' }, 'Start from a Discipline Loop shell, not a demo counter.'),
            h('p', { key: 'copy', className: 'hero-copy' },
                'This repo is prepared for Slice 0: choose a provider, lock the contracts, and ship the first vertical slice with gates, IPC wiring, and native desktop access already in place.'
            ),
