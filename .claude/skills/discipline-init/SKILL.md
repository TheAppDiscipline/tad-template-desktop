...
- If it persists, show the error and point the user to the "Windows / local environment" section of the common gate errors guide in the vault (sold separately), or the equivalent for their OS.
