...
**Action:** install a minimal Sentry for Gate D; see the Observability baseline section of the essential-security material in the vault (sold separately), or equivalent.
