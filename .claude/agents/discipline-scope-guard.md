...
- As a sub-call from a main agent that just finished a slice.
...
4. For each file changed:
   ...
   - If not, is it a reasonable side-effect?
...
- Decide whether a refactor is scope creep or necessary cleanup.
